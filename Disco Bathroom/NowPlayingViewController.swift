...
class NowPlayingViewController: UIViewController {
    ...
    @IBOutlet weak var totlLabel: UIButton!
    ...
    var flashTimer: CancelableTimer?
    var flashOptionIsOn = true
    var lightsOptionIsOn = false
    ...
    override func viewDidLoad() {
        ...
        totlLabel.layer.borderWidth = 1.0
        totlLabel.layer.borderColor = UIColor.whiteColor().CGColor
        totlLabel.layer.cornerRadius = 8
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        else if segue.identifier == "toTurnOnTheLights" {
            let lightsViewController = segue.destinationViewController as! LightsViewController
            lightsViewController.flashDelegate = self
            lightsViewController.lightsOptionIsOn = lightsOptionIsOn
            lightsViewController.flashOptionIsOn = flashOptionIsOn
        }
    }
    ...
    @IBAction func shareButtonPressed(sender: UIButton) {
        let songToShare = "I'm listening to \(track.title) on \(currentStation.stationName) via Disco Bathroom"
